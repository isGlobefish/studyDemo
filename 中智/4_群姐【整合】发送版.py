'''
Author: zoodehao
Date: 2021-07-15 17:04:51
LastEditTime: 2021-09-09 19:18:29
FilePath: \PyCode\4_群姐【整合】发送版.py
...
def export_file():
    ...
    # 加载格式框架
    # ----------------------------------------------------------------------------
    filepath = 'C:/Users/Zeus/Desktop/autoSend/4_群姐/目标/群姐_格式框架.xlsx'
    ...
    # 【目标 匹配表】数据准备
    # ----------------------------------------------------------------------------
    hexiao_target = pd.read_excel('C:/Users/Zeus/Desktop/autoSend/4_群姐/目标/群姐_数据源.xlsx', sheet_name=0, header=0)
    keke_target   = pd.read_excel('C:/Users/Zeus/Desktop/autoSend/4_群姐/目标/群姐_数据源.xlsx', sheet_name=1, header=0)
    area_divide   = pd.read_excel('C:/Users/Zeus/Desktop/autoSend/4_群姐/目标/群姐_数据源.xlsx', sheet_name=2, header=0)
    ...
    # 克咳片单位换算成件 - 去掉赠品
    kekeZSD043 = dataZSD043[((dataZSD043['物料描述'] == '克咳片-0.54g×16片') | (dataZSD043['物料描述'] == '克咳片-0.54g×32片')) & (dataZSD043['销售价'] > 0.02)].copy()
    ...
    # 秋冬大促时间范围8月-12月 - 去掉赠品
    qinZSD043 = kekeZSD043[(kekeZSD043['月份'] >= 8) & (kekeZSD043['销售价'] > 0.02)]
    qinZFI26  = kekeZFI26[(kekeZFI26['月份'] >= 8) & (kekeZFI26['赠品标识'] == '')]
    ...
    worksheet1.cell(row=3, column=6).value = '1-' + str(globalMonth) + '月累计完成情况'
    worksheet1.cell(row=3, column=10).value = str(globalMonth) + '月（1-' + str(globalDay) + '日）销售金额'
    worksheet1.cell(row=3, column=12).value = str(globalDay) + '日当天销售金额'
    ...
    worksheet2.cell(row=3, column=3).value = '1-' + str(globalMonth) + '月累计完成情况'
    worksheet2.cell(row=3, column=7).value = str(globalMonth) + '月（1-' + str(globalDay) + '日）销售金额'
    worksheet2.cell(row=3, column=9).value = str(globalDay) + '日当天销售金额'
    ...
    worksheet3.cell(row=3, column=4).value = '1-' + str(globalMonth) + '月累计完成情况'
    worksheet3.cell(row=3, column=8).value = str(globalMonth) + '月（1-' + str(globalDay) + '日）销售金额'
    worksheet3.cell(row=3, column=10).value = str(globalDay) + '日当天销售金额'
    ...
    worksheet4.cell(row=3, column=4).value = '1-' + str(globalMonth) + '月累计完成情况'
    worksheet4.cell(row=3, column=8).value = str(globalMonth) + '月（1-' + str(globalDay) + '日）销售金额'
    ...
    worksheet5.cell(row=3, column=4).value = '1-' + str(globalMonth) + '月累计完成情况'
    worksheet5.cell(row=3, column=8).value = str(globalMonth) + '月（1-' + str(globalDay) + '日）销售金额'
    worksheet5.cell(row=3, column=10).value = str(globalDay) + '日当天销售金额'
