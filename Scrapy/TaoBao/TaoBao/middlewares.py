...
from TaoBao.utils import create_chrome_driver, add_cookies
...
class TaobaoDownloaderMiddleware:
    ...
    def __init__(self):
        # 显示浏览器界面把headless改为False
        self.browser = create_chrome_driver(headless=False)
        self.browser.get('https://s.taobao.com/search?q=手机&s=0')
    ...
    def process_response(self, request, response: scrapy.Request, spider):
