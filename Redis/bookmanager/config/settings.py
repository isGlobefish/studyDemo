...
SECRET_KEY = 'django-insecure-hcvn%8p37cl*!vzk-77iphvm4(ok@qjlis!x!yc^j@ohuymv)4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', '127.0.0.1', '10.211.55.9']
...
INSTALLED_APPS = [
    ...
    'login',
    # 新版推荐使用该方法
    'pay.apps.PayConfig',  # pay.apps.PayConfig = pay
